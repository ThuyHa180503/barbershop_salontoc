                        ...
                        <div class="container-fluid">
                            <div class="hero__slider--items__inner">
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content" style="opacity: 0;">
                                            ...
                                            <p class="slider__content--desc desc2 d-sm-2-none mb-40">Giảm tới 40% các
                                                mặt hàng<br>
    ...
    <section class="product__section section--padding pt-0">
        <div class="container-fluid">
            <div class="section__heading text-center mb-35">
                <h2 class="section__heading--maintitle">DỊCH VỤ </h2>
            </div>
        ...
        <div class="container-fluid">
            <div class="deals__banner--inner banner__bg">
                <div class="row row-cols-1 align-items-center">
                    <div class="col">
                        <div class="deals__banner--content position__relative" style="opacity: 0;">
                            <span class="deals__banner--content__subtitle text__secondary">Hãy nhanh tay để được giảm
                                giá 25%</span>
                            <h2 class="deals__banner--content__maintitle">Ưu đãi trong ngày</h2>
                            <p class="deals__banner--content__desc">"Chương trình sale 25% trong ngày! Hãy nhanh tay mua
                                sắm để nhận ưu đãi hấp dẫn này!"</p>
            ...
            <div class="row row-cols-md-2 row-cols-1 mb--n28">
                <div class="col mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="./view/assets/img/banner/banner5.jpg" alt="banner-img">
                            <div class="banner__items--content" style="opacity: 0;">
                                <span class="banner__items--content__subtitle d-none d-lg-block">Chọn các mặt hàng của
                                    bạn</span>
                ...
                <div class="col mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="./view/assets/img/banner/banner6.jpg" alt="banner-img">
                            <div class="banner__items--content" style="opacity: 0;">
            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="banner__section--inner position__relative">
                        <a class="banner__items--thumbnail display-block" href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--height__md display-block" src="./view/assets/img/banner/banner-bg2.jpg" alt="banner-img">
                            <div class="banner__content--style2" style="opacity: 0;">
                                <h2 class="banner__content--style2__title text-white">Cần giày mùa đông?</h2>
                                <p class="banner__content--style2__desc">Bạn đang cần một đôi giày mùa đông vừa rẻ vừa
                                    chất lượng? Hãy đến ngay với chúng tôi!!!</p>

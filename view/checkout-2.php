<?php
add_notification(0, 'Có lịch hẹn mới: ' . $_GET['mahd']);
...
<div class="checkout__page--area">
            ...
            <div class="main checkout__mian">
                        ...
                        <summary class="order__summary--toggle border-radius-5">
                            <span class="order__summary--toggle__inner">
                                ...
                                <span class="order__summary--toggle__text show">
                                    <span>Hiển thị tóm tắt lịch hẹn</span>
                                ...
                                <table class="checkout__total--table">
                                    <tbody class="checkout__total--body">
                                        <tr class="checkout__total--items">
                                            <td class="checkout__total--title text-left">Tổng lịch hẹn </td>
                ...
                <main class="main__content_wrapper">
                    <div class="checkout__content--step section__shipping--address">
                        <h2 class="section__header--title h3">Thông tin lịch hẹn:</h2>
                        <div class="order__confirmed--area border-radius-5 mb-15">
                            <div class="section__header checkout__header--style3 position__relative mb-25">
                                <span class="checkout__order--number">lịch hẹn:
                                    <b><?= (isset($_GET['mahd'])) ? $_GET['mahd'] : ""; ?></b></span>
                                <h3 class="order__confirmed--title h4">Lịch hẹn của bạn đã được xác nhận! Vui lòng để ý thời gian để đến với chúng tôi!❤️❤️❤️</h3>
                            ...
                            <div class="customer__information--inner d-flex">
                                <div class="customer__information--list">
                                    <div class="customer__information--step">
                                        <h4 class="order__confirmed--title h4">Thông tin liên lạc</h4>
                                        <ul>
                                            <li><a class="customer__information--text__link" href="#">Họ
                                                    Tên:<?= $customer_info['name'] ?> </a></li>
                                            <li><a class="customer__information--text__link" href="#">Email:
                                                    <?= $customer_info['email'] ?></a></li>
                                            <li><a class="customer__information--text__link" href="#">SĐT:
                                                    <?= $customer_info['sdt'] ?></a></li>
                                        </ul>
                                    </div>
    ...
    <div class="container">
        <div class="checkout__content--step__footer d-flex align-items-center">
            <a class="continue__shipping--btn primary__btn border-radius-5" href="index.php?pg=shop">Xem cửa hàng</a>
            <a class="previous__link--content primary__btn border-radius-5" href="index.php?pg=my-account-3" style="color: white; margin-left: 65px;">Lịch sử đặt lịch</a>
            <button id="download-pdf" class="continue__shipping--btn primary__btn border-radius-5" style="margin-left: 65px">Xuất hóa đơn</button>
        </div>

...
foreach ($ordercart as $item) {
    extract($item);
    $totalPrice += $price * $soluong; // Cộng dồn giá của mỗi sản phẩm vào tổng giá
    // Code HTML tạo ra các mục sản phẩm trong giỏ hàng
    // ...
    ...
    <div class="container">
        <div class="checkout__page--inner d-flex">
                    ...
                    <details class="order__summary--mobile__version">
                        <summary class="order__summary--toggle border-radius-5">
                            <span class="order__summary--toggle__inner">
                                ...
                                <span class="order__summary--final__price"><?= number_format($tongthanhtoan, 0, ",", ".") ?></b>
                                    VNĐ</span>
                            </span>
                        </summary>
                                    ...
                                    <tfoot class="checkout__total--footer">
                                        <tr class="checkout__total--footer__items">
                                            ...
                                            <td class="checkout__total--footer__amount checkout__total--footer__list text-right">
                                                <?= number_format($tongthanhtoan, 0, ",", ".") ?> VNĐ</td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                    ...
                    <form action="#">
                        <div class="checkout__content--step section__shipping--address pt-0">
                            <div class="section__header checkout__header--style position__relative mb-25">
                                <h2 class="section__header--title h3">Chi tiết lịch hẹn: #<?= $mahd; ?></h2>
                                <span class="checkout__order--number">
                                    ...
                                    <div>Thời gian đặt lịch: <?= $date; ?></div>
                                ...
                                <div class="customer__information--inner d-flex">
                                    <div class="customer__information--list">
                                        <div class="customer__information--step">
                                            ...
                                            <ul>
                                                <li class="customer__information--text h3">Họ Tên:
                                                    <input class="checkout__input--field border-radius-5" placeholder="Họ và tên" type="text" name="name" value=" <?= $nguoidat_ten; ?>" required readonly>
                                                </li>

                                                <li class="customer__information--text h3">Email:
                                                    <input class="checkout__input--field border-radius-5" placeholder="Email" type="text" name="email" value="<?= $email ?>" required readonly>

                                                </li>

                                                <li class="customer__information--text h3">SĐT:
                                                    <input id="phone-input" class="checkout__input--field border-radius-5" placeholder="Số điện thoại" type="text" name="sdt" value="<?= $sdt ?>" required readonly>

                                                </li>
                                                <li class="customer__information--text h3">Ngày hẹn lịch:
                                                    <input id="phone-input" class="checkout__input--field border-radius-5" placeholder="appointment_date" type="date" name="appointment_date" value="<?= $appointment_date; ?>" required readonly>
                                                </li>
                                                <li class="customer__information--text h3">Thời gian hẹn lịch:
                                                    <input id="phone-input" class="checkout__input--field border-radius-5" placeholder="appointment_time" type="time" name="appointment_time" value="<?= $time; ?>" required readonly>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <aside class="checkout__sidebar sidebar">
                <h4 class="customer__information--subtitle h5">Thông tin lịch hẹn</h4>

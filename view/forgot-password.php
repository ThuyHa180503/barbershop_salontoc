    ...
    <div class="login__section section--padding">
        <div class="container">
            <div class="login__section--inner">
                <div class="row forgot-pass" style="text-align: center; justify-content: center; display: flex;">
                    <div class="col">
                        <div class="account__login">
                            <form action="index.php?pg=forgot-password" method="post">
                                <div class="account__login--header mb-25">
                                    ...
                                    <p class="account__login--header__desc"><span style="color: red; margin-right: 5px;">Lưu ý:</span>Vui lòng check mail đăng ký để lấy lại mật khẩu!</p>
                                </div>

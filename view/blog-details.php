                    ...
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.php">Trang
                                    chủ</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Chi Tiết Tin
                                    Tức</span></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="blog__details--wrapper">
                        <div class="entry__blog">
                            ...
                            <div class="blog__thumbnail mb-30">
                                <img class="blog__thumbnail--img border-radius-10" src="./uploads/<?= $img ?>" alt="blog-img">
                            </div>

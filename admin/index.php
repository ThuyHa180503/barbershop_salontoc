...
if (!isset($_GET['pg'])) {
  ...
  $count_product = product_all_services();
  ...
  switch ($_GET['pg']) {
    ...
    case 'report':
      $orderlist = get_order_home();
      $orderlist_get_orders_today = get_orders_today();
      $orderlist_get_orders_current_quarter = get_orders_current_quarter();
      $orderlist_get_orders_current_year = get_orders_current_year();
    ...
    case 'report_products':
      ...
      $monthly_revenue = get_monthly_revenue();
      $userlist = load_user(5);
      include "view/report_products.php";
      break;
    ...
    case 'services-list':
      ...
      $productlist = get_dssp_admin_services($kyw, $iddm, $page, $soluongsp);
      $tongsosp = get_dssp_all_services();
      $hienthisotrang = hien_thi_so_trang_services($tongsosp, $soluongsp);
      include "view/page-services-list.php";
      break;
    case 'updateproduct':
      $dsdm = danhmuc_all();
      $kyw = "";
      ...
      if (isset($_POST['updateproduct'])) {
        ...
        //update
        sanpham_update($name, $img, $price, $old_price, $describe1, $describe2, $bestseller, $hot, $new, $iddm, $id, $stock);
      }
    ...
    case 'updateservice':
      ...
      if (isset($_POST['updateproduct'])) {
        ...
        //update
        sanpham_update($name, $img, $price, $old_price, $describe1, $describe2, $bestseller, $hot, $new, $iddm, $id, 100);
      }
    ...
    case 'page-add-product':
      ...
      include "view/page-add-product.php";
      break;
    case 'page-add-services':
      $categorylist = danhmuc_all();
      include "view/page-add-services.php";
      break;
    ...
    case 'page-update-service':
      ...
      //trở về trang dssp
      $categorylist = danhmuc_all();
      include "view/page-update-service.php";
      break;
    ...
    case 'delproduct':
      ...
      if (isset($_GET['id']) && ($_GET['id'] > 0)) {
        ...
        try {
          ...
          alert('Sản phẩm đã có trong giỏ hàng! Không được quyền xóa!');
        </script>";
        }
      }
      //trở về trang dssp
    ...
    case 'delservice':
      ...
      //trở về trang dssp
      $soluongsp = 8;
      $productlist = get_dssp_admin_services($kyw, $iddm, 1, $soluongsp);
      $tongsosp = get_dssp_all_services();
      $hienthisotrang = hien_thi_so_trang_services($tongsosp, $soluongsp);
      include "view/page-services-list.php";
      break;
    ...
    case 'addproduct':
      if (isset($_POST['addproduct'])) {
        ...
        //insert into
        sanpham_insert($name, $img, $price, $old_price, $describe1, $describe2, $bestseller, $hot, $new, $iddm, $stock);
    ...
    case 'addservices':
      if (isset($_POST['addproduct'])) {
        ...
        //insert into
        services_insert($name, $img, $price, $old_price, $describe1, $describe2, $bestseller, $hot, $new, $iddm);
    ...
    case 'invoices':
      ...
      include "view/page-invoices.php";
      break;
    case 'add_orders':

      include "view/page-add-orders.php";
      break;
    case 'orders-detail':
      if (isset($_GET['id']) && ($_GET["id"] > 0)) {
        $id = $_GET['id'];
        ...
        $ordercart1 = get_cart_by_id_service($id);
    ...
    case 'invoices-detail':
      if (isset($_GET['id']) && ($_GET["id"] > 0)) {
        ...
        $ordercart1 = get_cart_by_id_service($id);
        $orderdetail = get_order_by_id($id);
        include "view/page-invoices-detail.php";
      } else {
        include "view/home.php";
      }
      break;
    case 'order-pending':
      if (isset($_GET['id']) && $_GET['id'] > 0) {
        ...
        $employee_id =  $_SESSION['s_user']['id'];

        update_employee_id($id, $employee_id);
        update_status($id, 1);
        $kyw = "";
        if (isset($_POST["search"])) {
          $kyw = $_POST["kyw"];
    ...
    case 'order-complete':
      if (isset($_GET['id']) && $_GET['id'] > 0) {
        $id = $_GET['id'];
        add_notification($_GET['iduser'], 'Lịch hẹn : ' . $_GET['mahd'] .  ' đã thành công!');
    ...
    case 'order-fail':
      ...
      break;
    case 'order-save': //thay bằng cancle

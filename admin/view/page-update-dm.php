                ...
                <div class="col-md-3">
                    <form action="index.php?pg=updatedm" method="POST" enctype="multipart/form-data">
                        <div class="mb-4">
                            ...
                            <input name="name" type="text" placeholder="Nhập tên danh mục" class="form-control"
                                id="product_slug" value="<?= ($dmid['name'] != "") ? $dmid['name'] : ""; ?>" />
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="input-upload">
                                    <img src="../uploads/<?= $dmid['img'] ?>" alt="">
                                    <input name="img" class="form-control" type="file">
                                </div>
                            </div>
                        </div>
                        <div class="d-grid">
                            <input type="hidden" name="id" value="<?= $dmid['id'] ?>">
                            <input type="hidden" name="old_img" value="<?= $dmid['img'] ?>">

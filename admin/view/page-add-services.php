...
<section class="content-main">
    <form action="index.php?pg=addservices" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12">
                <div class="content-header">
                    <h2 class="content-title">Thêm dịch vụ mới</h2>
                    <div>
                        <button type="submit" name="addproduct" class="btn btn-md rounded font-sm hover-up">Thêm dịch
                            vụ</button>
                    </div>
                </div>
            </div>
